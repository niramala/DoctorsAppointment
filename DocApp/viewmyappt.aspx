<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewmyappt.aspx.cs" Inherits="DocApp.viewmyappt" %>
    ...
    <div style="height: 90px; width: 1208px; background-color:#b6ff00;text-align:center; margin-bottom: 0px;">
        ...
        <ul>
            ...
            <div class="aa">
                ...
                <p>&nbsp;</p>
                <asp:GridView ID="GridView1" runat="server" Height="122px" Width="404px">
                </asp:GridView>
            </div>
    </form>
</body>
