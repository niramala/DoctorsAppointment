<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="myAbout.aspx.cs" Inherits="DocApp.WebForm2" %>
...
<body>
    ...
    <div style="height: 90px; width: 1208px; background-color:#b6ff00;text-align:center; margin-bottom: 0px;">
        ...
        <ul>
            ...
            <div class="aa">
            <h3><font size="7" color:"#000FF" ><b><i>We can help you to book an appointment for doctors according to your specification and your convenient date and timing</i></b></font></h3>
