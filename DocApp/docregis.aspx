<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="docregis.aspx.cs" Inherits="DocApp.WebForm5" %>
...
<body>
 <div style="height: 90px; width: 1208px; background-color:#b6ff00;text-align:center; margin-bottom: 0px;">
    ...
    <asp:Label ID="Label6" runat="server"  Text="Confirm_password"></asp:Label>
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="*Password must be same" ControlToValidate="TextBox6" ControlToCompare="TextBox5" Operator="Equal" Type="String" Display="Dynamic" ForeColor="Red"
