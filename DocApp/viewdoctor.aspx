<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="viewdoctor.aspx.cs" Inherits="DocApp.viewdoctor" %>
...
<body>
   ...
   <div style="height: 90px; width: 1208px; background-color:#b6ff00;text-align:center; margin-bottom: 0px;">
        ...
        <ul>
            ...
            <h3>Doctors List</h3>
                <p>&nbsp;</p>
                <asp:GridView ID="GridView1" runat="server" Height="276px" Width="502px">
                </asp:GridView>
            </div>
            </center>
    </form>
