<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="patregis.aspx.cs" Inherits="DocApp.WebForm4" %>
...
<body>
    ...
    <asp:Label ID="Label5" runat="server" Text="Password"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="<b>* Please enter password</b>" Display="Dynamic" ForeColor="Red"
    ...
    <asp:Label ID="Label6" runat="server"  Text="Confirm_password"></asp:Label>
        ...
        <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="Password must be same" ControlToValidate="TextBox6" ControlToCompare="TextBox5" Operator="Equal" Type="String" Display="Dynamic" ForeColor="Red"></asp:CompareValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ErrorMessage="<b>* Please re-enter password</b>" Display="Dynamic" ForeColor="Red"
    ...
    <asp:Label ID="Label7" runat="server" Text="Address"></asp:Label>
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ErrorMessage="<b>* Please enter address</b>" Display="Dynamic" ForeColor="Red"
                ControlToValidate="TextBox6" runat="server" />
    </p><br />
